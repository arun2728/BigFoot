...
def classify_dataset():
    return render_template('classification_dataset.html')

@app.route('/cluster_dataset')
def cluster_dataset():
    return render_template('clustering_dataset.html')

@app.route('/reg_dataset')
def reg_dataset():
    return render_template('regression_dataset.html')

@app.route('/vision_dataset')
def vision_dataset():
    return render_template('vision_dataset.html')
